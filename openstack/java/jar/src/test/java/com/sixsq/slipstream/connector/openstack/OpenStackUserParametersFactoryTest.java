...
public class OpenStackUserParametersFactoryTest extends CloudCredDefTestBase {

    @Test
    public void paramsDescriptionLoadedTest() throws ValidationException {
        UserParametersFactoryBase fb = new OpenStackUserParametersFactory("foo-bar-baz");
