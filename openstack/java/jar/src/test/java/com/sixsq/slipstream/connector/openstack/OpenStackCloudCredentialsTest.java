...
public class OpenStackCloudCredentialsTest extends CloudCredentialsTestBase {
	...
	public Map<String, UserParameter> createAndStoreCloudCredentials() throws ValidationException {
		...
		paramsKeyVal.put(OpenStackUserParametersFactory.KEY_TENANT_NAME, "tn");
		paramsKeyVal.put(OpenStackUserParametersFactory.KEY_DOMAIN_NAME, "dn");
	...
	public String getCloudServiceName() {
		return OpenStackConnector.CLOUD_SERVICE_NAME;
	}

	@Override
	public SystemConfigurationParametersFactoryBase getSystemConfParams()
			throws ValidationException {
      return new OpenStackSystemConfigurationParametersFactory(getConnectorName());
	}
}
