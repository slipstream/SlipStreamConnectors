...
public class OpenNebulaCloudCredentialsTest extends CloudCredentialsTestBase {
    ...
    public String getCloudServiceName() {
        return OpenNebulaConnector.CLOUD_SERVICE_NAME;
    }

    @Override
    public SystemConfigurationParametersFactoryBase getSystemConfParams()
            throws ValidationException {
        return new OpenNebulaSystemConfigurationParametersFactory(getConnectorName());
    }
}
