...
public class OpenNebulaCredentials extends CredentialsBase implements Credentials {
	...
	public OpenNebulaCredentials(User user, String connectorInstanceName) {
		super(user);
		try {
			cloudParametersFactory = new OpenNebulaUserParametersFactory(connectorInstanceName);
	...
	public String getKey() throws InvalidElementException {
		return getParameterValue(OpenNebulaUserParametersFactory.KEY_PARAMETER_NAME);
	}
