(ns com.sixsq.slipstream.ssclj.resources.credential-cloud-stratuslabiter
    ...
    [com.sixsq.slipstream.ssclj.resources.credential-template-cloud-stratuslabiter :as tpl]))
...
(def validate-fn (u/create-spec-validation-fn :cimi/credential.cloud-stratuslabiter))
(defmethod p/validate-subtype tpl/credential-type
  [resource]
  (validate-fn resource))

(def create-validate-fn (u/create-spec-validation-fn :cimi/credential.cloud-stratuslabiter.create))
