(ns com.sixsq.slipstream.ssclj.resources.credential-template-cloud-stratuslab
    "This CredentialTemplate allows creating a Cloud Credential instance to hold
    cloud credentials for StratusLab cloud."
    (:require
...
(def ^:const credential-type "cloud-cred-stratuslab")
(def ^:const method "store-cloud-cred-stratuslab")
...
(def validate-fn (u/create-spec-validation-fn :cimi/credential-template.cloud-stratuslab))
