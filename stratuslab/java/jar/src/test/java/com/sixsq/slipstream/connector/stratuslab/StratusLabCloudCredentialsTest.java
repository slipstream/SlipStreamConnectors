...
public class StratusLabCloudCredentialsTest extends CloudCredentialsTestBase {
	...
	public String getCloudServiceName() {
		return StratusLabConnector.CLOUD_SERVICE_NAME;
	}

	@Override
	public SystemConfigurationParametersFactoryBase getSystemConfParams()
			throws ValidationException {
		return new StratusLabSystemConfigurationParametersFactory(CONNECTOR_NAME);
	}
}
