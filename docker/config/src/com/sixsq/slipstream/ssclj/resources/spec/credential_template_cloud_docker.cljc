(ns com.sixsq.slipstream.ssclj.resources.spec.credential-template-cloud-docker
    (:require
...
;; Defines the contents of the cloud-docker CredentialTemplate resource itself.
(s/def ::credential-template
  (us/only-keys-maps ct/resource-keys-spec
                     ctc/credential-template-create-keys-spec
                     credential-template-keys-spec))

;; Defines the contents of the cloud-docker template used in a create resource.
